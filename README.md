...
Usa [Mi app en Deta Space]([https://deta.space/discovery/r/lvlxbrwtm85idcym](https://deta.space/discovery/r/picwku2bnhqhcywo)) para entrar en mi app y ver como funciona, una ves que la estes utilizando te aconsejo escribas /docs para que mires la documentacion y sepas que puedes introducir y como introducirlo.
